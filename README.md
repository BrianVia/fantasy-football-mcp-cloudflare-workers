...
> **Experimental branch:** a private three-tool multi-user pilot is implemented here; live provider setup and acceptance are pending. See the [pilot runbook](docs/PRIVATE_PILOT.md). Use [`main`](https://github.com/derekrbreese/fantasy-football-mcp-public/tree/main) for the supported personal server. See the [multi-user roadmap](docs/MULTI_USER_ROADMAP.md) for scope and milestones.
